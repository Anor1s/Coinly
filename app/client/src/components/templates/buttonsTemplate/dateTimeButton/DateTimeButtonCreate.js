  ...
  render(buttonConfig) {
    ...
    return `
      <div class="relative w-full flex flex-col gap-xs">
        ...
        <input
          class="datetime-input min-h-button px-[16px] bg-surface-response rounded cursor-pointer
                hover:bg-surface-secondary text-text-primary hover:text-text-tertiary [color-scheme:dark]
