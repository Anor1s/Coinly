  ...
  render(buttonConfig) {
    const html = `
      <div class="flex flex-col h-full w-full text-text-primary gap-xs">
        ...
        <div class="hover:bg-surface-secondary duration-200 transition-bg
                    bg-surface-response rounded flex flex-row justify-between
          ...
          <div class="hover:text-text-tertiary transition-color duration-200
            ...
            <input type="number"
                   class="w-full border-b border-border text-base"
                   placeholder="Min"
                   min="0"
