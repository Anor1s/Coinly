  ...
  render() {
    return `
      <div class="flex flex-col gap-xs w-full">
        ...
        <ul
          class="flex flex-row gap-sm bg-surface-response w-full px-[8px] mobile:px-[16px] h-button rounded"
          role="group"
          aria-labelledby="theme-label">
          <li class="my-auto h-[30px] w-[30px]">
            <button
              class="h-full w-full theme-button theme-active border-3 rounded-full text-text-primary border-border"
          ...
          <li class="my-auto h-[30px] w-[30px]">
            <button
              class="h-full w-full theme-button border-3 rounded-full text-text-primary border-border"
