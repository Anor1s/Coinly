  ...
  render() {
    const html = `
      <div class="h-full w-full justify-between flex flex-row  min-h-button
                       laptop:h-full  rounded-full bg-surface-response"
        role="search"
      >
        <input
          class=" min-h-button w-full hover:bg-surface-secondary active:bg-surface-secondary
                rounded-full  bg-surface-response pl-[16px]
        ...
        >
        <button
          class="px-[16px] mobile:px-[32px]  group hover:bg-surface-secondary active:bg-surface-secondary
